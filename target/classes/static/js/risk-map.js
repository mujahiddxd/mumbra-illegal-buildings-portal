...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Function to determine severity based on category ---
    function getSeverity(category) {
        // C2B categories are typically medium risk
        // You can adjust this logic based on your risk assessment criteria
    ...
    Papa.parse('buildings.csv', {
        ...
        complete: function(results) {
            ...
            results.data.forEach((b, idx) => {
                ...
                const severity = getSeverity(b.Category);
